...
ThemeData _buildTheme(Brightness brightness) {
  ...
  final accentSoft = isDark ? CohereColors.accentSoftDark : CohereColors.accentSoft;
  ...
  final colorScheme = ColorScheme(
    ...
    outlineVariant: isDark ? CohereColors.darkRuleSoft : CohereColors.hairlineSoft,
    surfaceContainerLowest: isDark ? CohereColors.darkPage : CohereColors.canvas,
    ...
    surfaceContainerHigh: isDark ? CohereColors.darkElev : CohereColors.softStone,
    surfaceContainerHighest: isDark ? CohereColors.darkElev : CohereColors.softStone,
  );
...
TextTheme _buildTextTheme(ColorScheme colorScheme) {
  ...
  return TextTheme(
    ...
    displayLarge: GoogleFonts.spaceGrotesk(
      ...
      letterSpacing: -2.4, height: 0.95, color: onSurface,
    ),
    displayMedium: GoogleFonts.spaceGrotesk(
      fontSize: 52, fontWeight: FontWeight.w400,
      letterSpacing: -1.4, height: 1.0, color: onSurface,
    ),
    displaySmall: GoogleFonts.spaceGrotesk(
      fontSize: 40, fontWeight: FontWeight.w400,
      letterSpacing: -0.8, height: 1.0, color: onSurface,
    ),
    // Headlines — Space Grotesk
    headlineLarge: GoogleFonts.spaceGrotesk(
      fontSize: 32, fontWeight: FontWeight.w400,
      letterSpacing: -0.6, height: 1.05, color: onSurface,
    ),
...
TextStyle cohereMonoLabel(BuildContext context, {
  double fontSize = 11,
  Color? color,
...
TextStyle cohereTabularTime(BuildContext context, {
  double fontSize = 18,
